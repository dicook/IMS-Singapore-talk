...
.footnote[`r icon::fa_creative_commons()`]
---
...
.footnote[`r icon::fa_creative_commons()` Schloerke et al (2016) "Escape from Boxland" The R Journal]
---
...
.footnote[`r icon::fa_creative_commons()` Wickham et al (2015) Visualizing statistical models: Removing the blindfold, SAM]
...
.footnote[`r icon::fa_creative_commons()` Slides made with Rmarkdown, xaringan package by Yihui Xie, and lorikeet theme using the [ochRe package](https://github.com/ropenscilabs/ochRe). Available at [https://github.com/dicook/IMS-Singapore-talk](https://github.com/dicook/IMS-Singapore-talk].)
